...
This project uses `state-memory-mcp` with project slug `"agent-reasoning-mcp"` to provide AI agents with a structured, persistent graph for tracking workflow state.
